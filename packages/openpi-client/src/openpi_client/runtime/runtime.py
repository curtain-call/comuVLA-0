...
class Runtime:
    ...
    def _step(self) -> None:
        ...
        if self._environment.is_episode_complete() or (
            ...
            print(f"self._environment.is_episode_complete() is {self._environment.is_episode_complete()}")
            print(f"self._max_episode_steps > 0 and self._episode_steps >= self._max_episode_steps is {self._max_episode_steps > 0 and self._episode_steps >= self._max_episode_steps}")
