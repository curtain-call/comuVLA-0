...
class DataConfigFactory(abc.ABC):
    ...
    def create_base_config(self, assets_dirs: pathlib.Path, root: str | None = None) -> DataConfig:
...
class LeRobotAlohaDataConfig(DataConfigFactory):
    ...
    @override
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig, root: str | None = None) -> DataConfig:
        ...
        return dataclasses.replace(
            self.create_base_config(assets_dirs, self.root),
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        # Choosing this value too small may chop off tokens at the end of your sequetrain_stepsnce (the code will throw
    ...
    TrainConfig(
        ...
        data=LeRobotAlohaDataConfig(
            ...
            root="/root/autodl-fs/openpi/datasets/aloha_insertion_human_v2_1/"
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("/root/autodl-fs/openpi/checkpoints/pi0_aloha_sim/fine_tune/9999/params/"),
        num_train_steps=20_000,
